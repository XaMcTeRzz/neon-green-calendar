      ...
      <CardContent className="p-3 text-center">
        <div className="mb-2 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h2 className="text-lg font-bold text-neon-green animate-neon-glow tracking-wide" style={{ fontFamily: 'Inter, sans-serif', letterSpacing: '0.05em' }}>Календар задач</h2>
          </div>
          <button
